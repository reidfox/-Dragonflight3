...
function setup:ApplyReforgedSkin(unitFrame)
    ...
    if isLarge then
        ...
        if isTarget then
            ...
            unitFrame.model:SetPoint('CENTER', unitFrame.portraitFrame, 'CENTER', -24, 5)
            ...
            unitFrame.infoBg:SetPoint('TOPRIGHT', unitFrame, 'TOPRIGHT', -100, -20)
            ...
            unitFrame.powerBar.bg:SetVertexColor(0.08, 0.08, 0.08, 0.9)
            unitFrame.infoBg:SetPoint('TOPLEFT', unitFrame, 'TOPLEFT', 100, -20)
        ...
        unitFrame.hpBar:SetSize(60, 13)
        unitFrame.hpBar:SetPoint('TOPLEFT', unitFrame, 'TOPLEFT', 40, -18)
        unitFrame.hpBar:SetFillDirection('LEFT_TO_RIGHT')
        unitFrame.hpBar:SetTextures(self.textures.reforgedMiniHealth, self.textures.reforgedMiniHealth)
        unitFrame.hpBar.bg:SetVertexColor(0.08, 0.08, 0.08, 0.9)
        unitFrame.powerBar:SetSize(60, 7)
        unitFrame.powerBar:SetPoint('TOPLEFT', unitFrame, 'TOPLEFT', 40, -31)
        unitFrame.powerBar:SetFillDirection('LEFT_TO_RIGHT')
        unitFrame.powerBar:SetTextures(self.textures.reforgedMiniPower, self.textures.reforgedMiniPower)
        unitFrame.powerBar.bg:SetVertexColor(0.08, 0.08, 0.08, 0.9)
        unitFrame.infoBg:SetSize(60, 14)
        unitFrame.infoBg:SetPoint('TOPLEFT', unitFrame, 'TOPLEFT', 40, -4)
