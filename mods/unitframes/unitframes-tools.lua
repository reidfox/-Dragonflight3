...
function setup:ApplyReforgedSkin(unitFrame)
    ...
    if isLarge then
        ...
        unitFrame.hpBar:SetPoint('TOPLEFT', unitFrame.reforgedFrame, 'TOPLEFT', 40 * compactScale, -18 * compactScale)
        unitFrame.hpBar:SetFillDirection('LEFT_TO_RIGHT')
        ...
        unitFrame.powerBar:SetPoint('TOPLEFT', unitFrame.reforgedFrame, 'TOPLEFT', 40 * compactScale, -31 * compactScale)
        unitFrame.powerBar:SetFillDirection('LEFT_TO_RIGHT')
